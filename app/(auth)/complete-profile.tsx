...
function DropdownPicker({
  ...
  return (
    <View style={{ zIndex: open ? 99 : 1 }}>
      <TouchableOpacity
        style={[dp.trigger, open && dp.triggerOpen]}
      ...
      >
        {iconName && (
          <Ionicons
            ...
            size={16}
            color="#94a3b8"
            style={dp.triggerIcon}
          />
        )}
        <Text style={selected ? dp.selected : dp.placeholder}>
      ...
      {open && (
        <View style={dp.dropdown}>
          {options.map((opt) => (
            <TouchableOpacity
              key={opt}
              style={[dp.option, selected === opt && dp.optionActive]}
              onPress={() => {
                onSelect(opt);
                setOpen(false);
              }}
            >
              <Text
                style={[dp.optionText, selected === opt && dp.optionTextActive]}
              >
                {opt}
              </Text>
              {selected === opt && (
    ...
    <View style={{ flexDirection: "row", gap: 10 }}>
      {GENDERS.map((g) => {
        ...
        return (
          <TouchableOpacity
            key={g.value}
            style={[gst.btn, active && gst.btnActive]}
          ...
          >
            ...
            />
            <Text style={[gst.label, active && gst.labelActive]}>
              {g.value}
            </Text>
          </TouchableOpacity>
        );
...
const route = role === "staff" ? "/complete-profile" : "/(student)/Home";
        ...
        >
          <View style={s.pendingCard}>
            ...
            <Text style={s.pendingDesc}>
              Your account is under review. Please wait up to 24 hours for admin
              approval.
            </Text>
  ...
  const roleSubtitle =
    role === "student"
      ? "Please fill in your academic details to continue"
      : role === "teacher"
        ...
        >
          ...
          <View style={s.roleHeader}>
            <View style={s.roleIconCircle}>
              <Ionicons
                name={roleIconMap[role] || "person-outline"}
                size={24}
                color="#16a34a"
              />
            </View>
            <View style={{ flex: 1 }}>
              <Text style={s.roleLabelSmall}>
          ...
          {role === "teacher" && (
            <>
              ...
              <View style={s.inputWrap}>
                ...
                <TextInput
                  style={s.input}
                  placeholder="Enter ID e.g. T-2024-001"
                  placeholderTextColor="#9ca3af"
                  value={teacherId}
              ...
              <FileUploadBox
                label="Upload Teacher ID Card"
                iconName="id-card-outline"
                file={teacherIdCard}
                onPick={() => pickFile(setTeacherIdCard)}
              />
            </>
          )}
              ...
              <View style={s.uploadRow}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <FileUploadBox
                    ...
                    file={certificate}
                    onPick={() => pickFile(setCertificate)}
                  />
                </View>
              </View>
            </>
