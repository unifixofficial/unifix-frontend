...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    if (!validateEmail(email, role)) {
      return setError(
        role === "student"
          ? "Students must use a @vcet.edu.in email."
          : "Teachers must use a @vcet.edu.in email.",
      );
    }
    if (!agreedToTerms)
      ...
      >
        ...
        >
          ...
          <Text
            ...
            onPress={(e) => {
              e.stopPropagation();
              router.push("/legal/terms-and-conditions?type=terms");
            }}
          >
            Terms & Conditions
          </Text>
        ...
        <TouchableOpacity
          style={[s.signupBtn, (loading || !agreedToTerms) && s.btnDisabled]}
        ...
        <View style={s.footerRow}>
          <TouchableOpacity
            onPress={() => router.push("/legal/terms-and-conditions?type=terms")}
          >
            <Text style={s.footerText}>Terms & Conditions</Text>
          </TouchableOpacity>
          <Text style={s.footerDot}> · </Text>
          <TouchableOpacity
            onPress={() => router.push("/legal/terms-and-conditions?type=privacy")}
          >
